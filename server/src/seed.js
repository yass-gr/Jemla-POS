...
const IMG_S = '?w=400&h=400&fit=crop&auto=format&q=80';

const products = [
  {name:'Tomate',cat:'Légumes',price:6,unit:'kg',stock:500,img:`${IMG}gWH8cus3-oU${IMG_S}`,barcode:'6111000000001',pw:4.5,wmq:20},
  {name:'Pomme de terre',cat:'Légumes',price:4,unit:'kg',stock:800,img:`${IMG}JqYqM-udWH4${IMG_S}`,barcode:'6111000000002',pw:2.8,wmq:25},
  {name:'Oignon',cat:'Légumes',price:3.5,unit:'kg',stock:600,img:`${IMG}sjUImLxUCyA${IMG_S}`,barcode:'6111000000003',pw:2.2,wmq:30},
  {name:'Carotte',cat:'Légumes',price:5,unit:'kg',stock:450,img:`${IMG}Xlam9v1Mrrc${IMG_S}`,barcode:'6111000000004',pw:3.5,wmq:20},
  {name:'Courgette',cat:'Légumes',price:7,unit:'kg',stock:350,img:`${IMG}UrLT3x0x9sA${IMG_S}`,barcode:'6111000000005',pw:5,wmq:15},
  {name:'Aubergine',cat:'Légumes',price:6.5,unit:'kg',stock:300,img:`${IMG}Rkf0aVfPIi0${IMG_S}`,barcode:'6111000000006',pw:4.5,wmq:15},
  {name:'Poivron vert',cat:'Légumes',price:9,unit:'kg',stock:280,img:`${IMG}3N_znw90QlU${IMG_S}`,barcode:'6111000000007',pw:6.5,wmq:12},
  {name:'Poivron rouge',cat:'Légumes',price:12,unit:'kg',stock:250,img:`${IMG}Rkf0aVfPIi0${IMG_S}`,barcode:'6111000000008',pw:8.5,wmq:12},
  {name:'Chou vert',cat:'Légumes',price:4,unit:'kg',stock:400,img:`${IMG}NkTQp793cAM${IMG_S}`,barcode:'6111000000009',pw:2.8,wmq:20},
  {name:'Chou rouge',cat:'Légumes',price:5,unit:'kg',stock:350,img:`${IMG}NkTQp793cAM${IMG_S}`,barcode:'6111000000010',pw:3.5,wmq:20},
  {name:'Laitue',cat:'Légumes',price:2.5,unit:'kg',stock:500,img:`${IMG}FndoTd4WuNo${IMG_S}`,barcode:'6111000000011',pw:1.8,wmq:25},
  {name:'Épinard',cat:'Légumes',price:5,unit:'kg',stock:250,img:`${IMG}2wy8JIfhwHE${IMG_S}`,barcode:'6111000000012',pw:3.5,wmq:15},
  {name:'Brocoli',cat:'Légumes',price:10,unit:'kg',stock:200,img:`${IMG}_3lCnNKmmcc${IMG_S}`,barcode:'6111000000013',pw:7,wmq:10},
  {name:'Chou-fleur',cat:'Légumes',price:8,unit:'kg',stock:220,img:`${IMG}-AHeCyy1WHc${IMG_S}`,barcode:'6111000000014',pw:5.5,wmq:12},
  {name:'Navet',cat:'Légumes',price:4,unit:'kg',stock:300,img:`${IMG}Xlam9v1Mrrc${IMG_S}`,barcode:'6111000000015',pw:2.8,wmq:20},
  {name:'Radis',cat:'Légumes',price:3,unit:'kg',stock:350,img:`${IMG}FndoTd4WuNo${IMG_S}`,barcode:'6111000000016',pw:2,wmq:25},
  {name:'Céleri',cat:'Légumes',price:6,unit:'kg',stock:180,img:`${IMG}_7iyR_lX0LU${IMG_S}`,barcode:'6111000000017',pw:4.2,wmq:12},
  {name:'Persil',cat:'Légumes',price:4,unit:'kg',stock:400,img:`${IMG}FndoTd4WuNo${IMG_S}`,barcode:'6111000000018',pw:2.8,wmq:20},
  {name:'Coriandre',cat:'Légumes',price:5,unit:'kg',stock:350,img:`${IMG}FndoTd4WuNo${IMG_S}`,barcode:'6111000000019',pw:3.5,wmq:15},
  {name:'Menthe',cat:'Légumes',price:6,unit:'kg',stock:300,img:`${IMG}FndoTd4WuNo${IMG_S}`,barcode:'6111000000020',pw:4.2,wmq:15},
  {name:'Ail',cat:'Légumes',price:28,unit:'kg',stock:150,img:`${IMG}uSP_kh-yOyE${IMG_S}`,barcode:'6111000000021',pw:20,wmq:5},
  {name:'Gingembre',cat:'Légumes',price:35,unit:'kg',stock:100,img:`${IMG}JqYqM-udWH4${IMG_S}`,barcode:'6111000000022',pw:25,wmq:5},
  {name:'Patate douce',cat:'Légumes',price:7,unit:'kg',stock:350,img:`${IMG}JqYqM-udWH4${IMG_S}`,barcode:'6111000000023',pw:5,wmq:15},
  {name:'Betterave',cat:'Légumes',price:5,unit:'kg',stock:280,img:`${IMG}G1HYhDnaks0${IMG_S}`,barcode:'6111000000024',pw:3.5,wmq:15},
  {name:'Concombre',cat:'Légumes',price:5,unit:'kg',stock:450,img:`${IMG}UrLT3x0x9sA${IMG_S}`,barcode:'6111000000025',pw:3.5,wmq:20},
  {name:'Haricots verts',cat:'Légumes',price:11,unit:'kg',stock:250,img:`${IMG}_3lCnNKmmcc${IMG_S}`,barcode:'6111000000026',pw:8,wmq:10},
  {name:'Petits pois',cat:'Légumes',price:14,unit:'kg',stock:200,img:`${IMG}_3lCnNKmmcc${IMG_S}`,barcode:'6111000000027',pw:10,wmq:10},
  {name:'Fèves fraîches',cat:'Légumes',price:8,unit:'kg',stock:220,img:`${IMG}_3lCnNKmmcc${IMG_S}`,barcode:'6111000000028',pw:5.5,wmq:12},
  {name:'Artichaut',cat:'Légumes',price:9,unit:'kg',stock:180,img:`${IMG}gRqbd0UldN8${IMG_S}`,barcode:'6111000000029',pw:6.5,wmq:10},
  {name:'Asperges',cat:'Légumes',price:25,unit:'kg',stock:80,img:`${IMG}rTGDPstmhhA${IMG_S}`,barcode:'6111000000030',pw:18,wmq:5},
  {name:'Orange Navel',cat:'Fruits',price:7,unit:'kg',stock:600,img:`${IMG}8j_wonaBqVg${IMG_S}`,barcode:'6111000000031',pw:5,wmq:25},
  {name:'Orange Sanguine',cat:'Fruits',price:9,unit:'kg',stock:400,img:`${IMG}8j_wonaBqVg${IMG_S}`,barcode:'6111000000032',pw:6.5,wmq:20},
  {name:'Clémentine',cat:'Fruits',price:10,unit:'kg',stock:500,img:`${IMG}8j_wonaBqVg${IMG_S}`,barcode:'6111000000033',pw:7,wmq:20},
  {name:'Mandarine',cat:'Fruits',price:11,unit:'kg',stock:450,img:`${IMG}8j_wonaBqVg${IMG_S}`,barcode:'6111000000034',pw:8,wmq:20},
  {name:'Citron',cat:'Fruits',price:9,unit:'kg',stock:550,img:`${IMG}kTj3KSeydEk${IMG_S}`,barcode:'6111000000035',pw:6.5,wmq:20},
  {name:'Pamplemousse',cat:'Fruits',price:8,unit:'kg',stock:300,img:`${IMG}8j_wonaBqVg${IMG_S}`,barcode:'6111000000036',pw:5.5,wmq:15},
  {name:'Fraise',cat:'Fruits',price:22,unit:'kg',stock:200,img:`${IMG}ww-40NflRjA${IMG_S}`,barcode:'6111000000037',pw:16,wmq:8},
  {name:'Cerise',cat:'Fruits',price:35,unit:'kg',stock:120,img:`${IMG}3HhXWJzG5Ko${IMG_S}`,barcode:'6111000000038',pw:25,wmq:5},
  {name:'Pêche',cat:'Fruits',price:16,unit:'kg',stock:280,img:`${IMG}7ySNLr1CtPs${IMG_S}`,barcode:'6111000000039',pw:11,wmq:10},
  {name:'Abricot',cat:'Fruits',price:18,unit:'kg',stock:250,img:`${IMG}7ySNLr1CtPs${IMG_S}`,barcode:'6111000000040',pw:13,wmq:10},
  {name:'Prune',cat:'Fruits',price:14,unit:'kg',stock:300,img:`${IMG}UXHVgZDE82I${IMG_S}`,barcode:'6111000000041',pw:10,wmq:12},
  {name:'Nectarine',cat:'Fruits',price:17,unit:'kg',stock:260,img:`${IMG}7ySNLr1CtPs${IMG_S}`,barcode:'6111000000042',pw:12,wmq:10},
  {name:'Pastèque',cat:'Fruits',price:3.5,unit:'kg',stock:800,img:`${IMG}qxHshSm7XQU${IMG_S}`,barcode:'6111000000043',pw:2.5,wmq:30},
  {name:'Melon Cantaloup',cat:'Fruits',price:6,unit:'kg',stock:400,img:`${IMG}qxHshSm7XQU${IMG_S}`,barcode:'6111000000044',pw:4.2,wmq:15},
  {name:'Melon Vert',cat:'Fruits',price:7,unit:'kg',stock:350,img:`${IMG}qxHshSm7XQU${IMG_S}`,barcode:'6111000000045',pw:5,wmq:15},
  {name:'Banane',cat:'Fruits',price:11,unit:'kg',stock:700,img:`${IMG}A4IIDSz6bTM${IMG_S}`,barcode:'6111000000046',pw:8,wmq:25},
  {name:'Ananas',cat:'Fruits',price:15,unit:'kg',stock:250,img:`${IMG}X5TWtOWHJkY${IMG_S}`,barcode:'6111000000047',pw:11,wmq:10},
  {name:'Mangue',cat:'Fruits',price:28,unit:'kg',stock:150,img:`${IMG}8j_wonaBqVg${IMG_S}`,barcode:'6111000000048',pw:20,wmq:8},
  {name:'Avocat',cat:'Fruits',price:18,unit:'kg',stock:300,img:`${IMG}_eIETuS3kOQ${IMG_S}`,barcode:'6111000000049',pw:13,wmq:10},
  {name:'Kiwi',cat:'Fruits',price:16,unit:'kg',stock:280,img:`${IMG}XrrDKWZp-HY${IMG_S}`,barcode:'6111000000050',pw:11,wmq:10},
  {name:'Pomme Golden',cat:'Fruits',price:12,unit:'kg',stock:500,img:`${IMG}NoiJZhDF4Es${IMG_S}`,barcode:'6111000000051',pw:8.5,wmq:20},
  {name:'Pomme Gala',cat:'Fruits',price:13,unit:'kg',stock:480,img:`${IMG}NoiJZhDF4Es${IMG_S}`,barcode:'6111000000052',pw:9,wmq:20},
  {name:'Pomme Granny Smith',cat:'Fruits',price:14,unit:'kg',stock:450,img:`${IMG}NoiJZhDF4Es${IMG_S}`,barcode:'6111000000053',pw:10,wmq:20},
  {name:'Poire Williams',cat:'Fruits',price:15,unit:'kg',stock:350,img:`${IMG}1tUZoeQiSC0${IMG_S}`,barcode:'6111000000054',pw:11,wmq:15},
  {name:'Poire Conference',cat:'Fruits',price:14,unit:'kg',stock:380,img:`${IMG}1tUZoeQiSC0${IMG_S}`,barcode:'6111000000055',pw:10,wmq:15},
  {name:'Raisin Noir',cat:'Fruits',price:18,unit:'kg',stock:300,img:`${IMG}u9JsIsIMU94${IMG_S}`,barcode:'6111000000056',pw:13,wmq:10},
  {name:'Raisin Blanc',cat:'Fruits',price:19,unit:'kg',stock:280,img:`${IMG}u9JsIsIMU94${IMG_S}`,barcode:'6111000000057',pw:14,wmq:10},
  {name:'Raisin Rouge',cat:'Fruits',price:20,unit:'kg',stock:260,img:`${IMG}u9JsIsIMU94${IMG_S}`,barcode:'6111000000058',pw:14.5,wmq:10},
  {name:'Grenade',cat:'Fruits',price:12,unit:'kg',stock:350,img:`${IMG}jKx14bHqYTU${IMG_S}`,barcode:'6111000000059',pw:8.5,wmq:15},
  {name:'Figues fraîches',cat:'Fruits',price:32,unit:'kg',stock:100,img:`${IMG}UXHVgZDE82I${IMG_S}`,barcode:'6111000000060',pw:23,wmq:5},
  {name:'Dattes Deglet Nour',cat:'Fruits',price:45,unit:'kg',stock:180,img:`${IMG}JqYqM-udWH4${IMG_S}`,barcode:'6111000000061',pw:32,wmq:5},
  {name:'Coing',cat:'Fruits',price:10,unit:'kg',stock:200,img:`${IMG}1tUZoeQiSC0${IMG_S}`,barcode:'6111000000062',pw:7,wmq:10},
];
...
async function seed() {
  ...
  for (const p of products) {
    exec('INSERT INTO products (name,category,price,unit,stock,image_url,barcode,price_wholesale,wholesale_min_qty) VALUES (?,?,?,?,?,?,?,?,?)',
      [p.name, p.cat, p.price, p.unit, p.stock, p.img, p.barcode, p.pw, p.wmq]);
  }
