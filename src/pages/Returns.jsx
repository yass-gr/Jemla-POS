  ...
  return (
    <div className="space-y-5 pb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="h-[105px] p-4 bg-white dark:bg-card rounded-[20px] shadow-[0_4px_20px_rgba(15,23,42,0.04)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.5)] border border-[#F1F5F9] dark:border-border flex flex-col justify-between dark:bg-gradient-to-br dark:border-amber-800/60 dark:from-card dark:to-amber-950/40">
          <div className="flex justify-between items-start">
